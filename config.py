...
class BotConfig:
    ...
    testnet: bool = os.getenv("BYBIT_TESTNET", "false").lower() == "false"
    demo: bool = os.getenv("BYBIT_DEMO", "true").lower() == "true"
    ...
    def validate(self) -> None:
        ...
        if not self.testnet and not self.demo:
            import warnings
            warnings.warn(
                "BYBIT_TESTNET=false and BYBIT_DEMO=false — bot will connect to LIVE mainnet.",
                stacklevel=2,
            )