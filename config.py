...
class BotConfig:
    ...
    symbols: list[str] = field(
        default_factory=lambda: ["SOLUSDT", "AVAXUSDT", "DOGEUSDT"]
    )
    ...
    risk_usd_per_trade: float = 10.0       # ← was 5.0 (too tight, was killing signals)
    fixed_notional_usd: float = 100.0      # ← was 3000.0 (caused margin rejection on demo)
